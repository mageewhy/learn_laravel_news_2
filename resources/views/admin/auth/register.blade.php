...
<html lang="en">
<head>
    <title>Laravel News - HTML5 Register</title>
					...
					<div class="auth-form-container text-start mx-auto">
						<form class="auth-form auth-signup-form" method="POST" action="{{route('register')}}">
							...
							<div class="email mb-3">
								...
								<input id="name" name="name" type="text" class="form-control signup-name" placeholder="Full name" required="required">
							</div>
							<div class="email mb-3">
                            ...
                            <div class="password mb-3">
								...
								<input id="password_confirmation" name="password_confirmation" type="password" class="form-control signup-password" placeholder="Confirm Password" required="required">
							</div>
